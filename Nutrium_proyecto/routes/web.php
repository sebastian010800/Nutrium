...
Route::post('Registrar.store',[App\Http\Controllers\ADTController::class,'store'])->name('adt.store');
...
Route::post('Localidad.store',[App\Http\Controllers\LocalidadController::class,'store'])->name('localidad.store');
